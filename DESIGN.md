...
|------|-------|-------|------|
| Prussian Blue | `#00345A` | `--color-prussian-blue` | Primary background for dark sections, elevated card surfaces, and navigation elements. Provides depth as a foundational dark tone. |
...
| Lochmara | `#0074C8` | `--color-lochmara` | Interactive link text, borders for ghost buttons, and secondary action calls. The primary interactive blue. |
| Sky Surge | `#097fe8` | `--color-sky-surge` | Informational badges, active navigation states, and subtle decorative fills. Slightly brighter than Lochmara, for emphasis. |
...
### Figtree — The primary workhorse typeface for all UI elements, body text, and most headings. Its varied weights and precise letter-spacing allow for distinct hierarchy and high legibility across all sizes, from tiny labels to prominent headlines. · `--font-figtree`
- **Substitute:** Inter
...
- **Role:** The primary workhorse typeface for all UI elements, body text, and most headings. Its varied weights and precise letter-spacing allow for distinct hierarchy and high legibility across all sizes, from tiny labels to prominent headlines.

### Lyon Text — Used sparingly for specific, stylized headings, potentially for editorial or feature-focused content. Its serif nature offers a tactile, almost printed feel compared to the geometric Figtree. · `--font-lyon-text`
- **Substitute:** Georgia
- **Weights:** 400
- **Sizes:** 32px
- **Line height:** 1.25
- **Letter spacing:** normal
- **Role:** Used sparingly for specific, stylized headings, potentially for editorial or feature-focused content. Its serif nature offers a tactile, almost printed feel compared to the geometric Figtree.
...
Solid background button for primary actions. Uses Lochmara (`#0074C8`) as background, Paper White (`#ffffff`) text (Figtree, weight 400). Has 8px border-radius and 12px vertical, 16px horizontal padding.

### Ghost Header Navigation Button
**Role:** Ghost Button

Transparent background button for navigation items in the header. Uses Paper White (`#ffffff`) text (Figtree, weight 400) and a transparent background. Has an 8px border-radius, with 6px vertical and 15px horizontal padding.

### Feature Card (Dark Background)
**Role:** Card

Card with a deep background for featuring product capabilities. Uses Prussian Blue (`#00345A`) as background, 12px border-radius, and 24px padding on all sides. No shadow.
...
Outlined button with Ghost White (`#f6f5f4`) text (Figtree, weight 400), transparent background, and 4px border-radius. Padding is 5px vertical and 10px horizontal.

### Muted Navigation Button
**Role:** Ghost Button

Subtle ghost button for secondary navigation or actions. Uses Deep Slate (`#615d59`) text (Figtree, weight 400), transparent background, and 8px border-radius. Padding is 12px vertical and 16px horizontal.
...
Informational badge. Uses Off White (`#f2f9ff`) background, Sky Surge (`#097fe8`) text (Figtree, weight 400), 9999px radius (pill shape), and 4px vertical, 8px horizontal padding.

## Do's and Don'ts

### Do
- Prioritize Figtree typeface (#000000 on dark, #ffffff on light) for all body text and UI labels, ensuring consistent letter-spacing from the type scale.
- Use Prussian Blue (`#00345A`) as the default background for large hero sections and prominent cards in dark mode interfaces.
- Implement Lochmara (`#0074C8`) exclusively for primary call-to-action buttons, pairing it with Paper White (`#ffffff`) text.
...
- Utilize Lochmara (`#0074C8`) for all interactive link text and subtle button outlines to indicate interactivity without distraction.
...
### Don't
- Do not use generic gray backgrounds; instead, leverage the nuanced shades of Prussian Blue (`#00345A`) and Canvas Dark (`#000000`) for visual depth in dark themes.
...
- Do not vary letter-spacing for Figtree text unless it adheres strictly to the defined type scale's specific values for each role.
...
| 1 | Prussian Blue | `#00345A` | Primary background for hero sections and elevated dark cards, offering a rich, deep hue. |
...
Create a Primary Action Button: Lochmara (`#0074C8`) background, #ffffff text, 8px radius, 12px/16px padding. Use this filled treatment for the main CTA.

Example Component Prompts:
Create a feature card: Paper White (#ffffff) background. 12px radius, 24px padding. Headline at 22px Figtree weight 600, #000000, letter-spacing -0.0240em. Body text at 15px Figtree weight 400, #0b0b0b, letter-spacing -0.0060em.
Create an informational badge: Off White (#f2f9ff) background. Sky Surge (#097fe8) text at 12px Figtree weight 400, 9999px radius, 4px 8px padding.
...
:root {
  /* Colors */
  --color-prussian-blue: #00345A;
  --color-lochmara:      #0074C8;
